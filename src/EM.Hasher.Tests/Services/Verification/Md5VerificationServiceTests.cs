...
[TestClass]
public class Md5VerificationServiceTests
{
    ...
    private const string CalculatedHash =
        "0daddf8ce1b2e740a1331ade98a6637e";

    private static Md5VerificationService CreateSut()
    {
        return new Md5VerificationService();
    }
    ...
    public async Task VerifyAsync_MatchingHash_ReturnsMatchAsync()
    {
        ...
        result.HashVerificationDescription.Should().Contain("TestFile.md5");
    }
